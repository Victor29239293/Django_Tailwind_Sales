...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dni', models.CharField(blank=True, max_length=13, null=True, validators=[proy_sales.utils.valida_ruc], verbose_name='RUC')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['description'],
                'indexes': [models.Index(fields=['description'], name='core_brand_descrip_5b1a81_idx')],
            },
        ),
        migrations.CreateModel(
            name='Customer',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dni', models.CharField(blank=True, max_length=13, null=True, unique=True, validators=[proy_sales.utils.valida_cedula], verbose_name='Dni')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stock', models.IntegerField(default=100, validators=[proy_sales.utils.valida_numero_entero_positivo], verbose_name='Stock')),
                ('expiration_date', models.DateField(default=datetime.datetime(2025, 4, 5, 4, 24, 18, 36828, tzinfo=datetime.timezone.utc), verbose_name='Caducidad')),
                ('manufacture_date', models.DateField(default=django.utils.timezone.now, verbose_name='Fecha de Elaboración')),
                ...
                ('active', models.BooleanField(default=True, verbose_name='Activo')),
                ('brand', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='product_brands', to='core.brand', verbose_name='Marca')),
                ('categories', models.ManyToManyField(related_name='products_categories', to='core.category', verbose_name='Categoria')),
                ('iva', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='product_iva', to='core.iva', verbose_name='Iva')),
                ('line', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='product_lines', to='core.line', verbose_name='Linea')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.BooleanField(default=True, verbose_name='Activo')),
                ('category', models.ManyToManyField(blank=True, related_name='productPrice_categories', to='core.category', verbose_name='Categoria')),
                ('line', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='productPrice_lines', to='core.line', verbose_name='Linea')),
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='productPrice', to='core.product', verbose_name='Producto Precio')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issue_date', models.DateField(default=django.utils.timezone.now, verbose_name='Fecha Emision')),
                ('observation', models.TextField(blank=True, null=True)),
                ('active', models.BooleanField(default=True, verbose_name='Activo')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='price_detail', to='core.product', verbose_name='Producto Precio detalle')),
                ('productpreci', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='productPrice_detail', to='core.productprice', verbose_name='Producto Precio detalle')),
            ],
            options={
