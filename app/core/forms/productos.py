...
import datetime
from app.core.models import Product, Brand, Iva, Line, Category

class ProductForm(ModelForm):
    class Meta:
        model = Product
        fields = [
            "description", "brand", "cost", "price", "stock", "iva", 
            "expiration_date", "manufacture_date", "line", "categories", "image", "state", "active"
        ]
        error_messages = {
            "description": {
                "unique": "Ya existe un producto con esta descripción.",
            }
        }
        widgets = {
            ...
            "manufacture_date": forms.TextInput(
                attrs={
                    "placeholder": "Ingrese la fecha de Elaboración",
                    "id": "id_manufacture_date",
                    "class": "shadow-sm bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 pr-12 dark:bg-principal dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light",
                    "type": "date"
                }
            ),
